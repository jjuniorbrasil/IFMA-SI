  ...
  do {                                // Loop que se repete até a variável 'fdj' (fim de jogo) mudar de '0' para '1'.
    ...
    printf("================================================ DICA =====\n\n");
      ...
      if (n == x) {
         ...
         fdj = 1;
        ...
        else if (cont < 5) {         // As dicas foram divididas e agrupadas dentro 'switches aleatórios' que existem de funções de mesmo nome.
          dicasmedias(n, x); 
        } else {
          dicasfaceis(n, x);
        }
          ...
          t++;                        
            ...
            if (t > 3) {            // Se o número de tentativas passar de '3', o jogador perde a rodada.
