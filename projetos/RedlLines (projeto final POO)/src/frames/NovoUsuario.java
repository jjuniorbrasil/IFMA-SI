...
public class NovoUsuario extends javax.swing.JFrame {
    ...
    private void CadButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CadButtonActionPerformed
        ...
        File usuarioFile = new File(pastaUsuarios, user + ".txt");
        
        if (usuarioFile.exists() || user.equals("admin")) {
            Object[] options = {"OK"};
            JOptionPane.showOptionDialog(null, "Usuário já existe!", "ERRO",JOptionPane.DEFAULT_OPTION, JOptionPane.YES_OPTION,null,options, options[0]);
        } else {
            if (pass.equals(confirmpass)) {
                ...
                Object[] options = {"OK"};
                JOptionPane.showOptionDialog(null, "Senhas não coincidem!", "ERRO",JOptionPane.DEFAULT_OPTION, JOptionPane.YES_OPTION,null,options, options[0]);
            }
        }
