...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        try {
        URL imageUrl = getClass().getClassLoader().getResource("assets/icons/favicon-32x32.png");
    ...
    private void initComponents() {
        ...
        DiretorioRelatorioLabel = new javax.swing.JLabel();
        ...
        DiretorioRelatorioLabel.setFont(new java.awt.Font("Ebrima", 1, 10)); // NOI18N
        DiretorioRelatorioLabel.setForeground(new java.awt.Color(51, 255, 51));
        DiretorioRelatorioLabel.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                DiretorioRelatorioLabelFocusLost(evt);
            }
        });
                        ...
                        .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(MainPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(DiretorioRelatorioLabel))
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addGap(6, 6, 6)
        ...
        MainPanelLayout.setVerticalGroup(
            ...
            .addGroup(MainPanelLayout.createSequentialGroup()
                ...
                .addGroup(MainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(MainPanelLayout.createSequentialGroup()
                        .addComponent(RelatorioLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(DiretorioRelatorioLabel)))
...
//
    try {
        ...
        String caminhoRelatorios = diretorioAtual + File.separator + "Relatorios";
        File pastaRelatorios = new File(caminhoRelatorios);
        if (!pastaRelatorios.exists()) {
            pastaRelatorios.mkdirs();
        }
        File relatorio = new File(pastaRelatorios, arquivo + ".txt");
        FileWriter registrar = new FileWriter(relatorio);
        ...
        if (relatorio.createNewFile()) {
            ...
            jTextArea1.setText("");
            RelatorioLabel.setText("Relatório gerado com sucesso!");
            DiretorioRelatorioLabel.setText("Criado em: " + pastaRelatorios.toString());
        } else {
            System.out.println("O arquivo já existe. Sobreescrevendo.");
            registrar.append("\n" + arquivo);
            registrar.append("\n" + jTextArea1.getText());
...
//
    ...
    private void formMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseClicked
        ...
        DiretorioRelatorioLabel.setText("");
    ...
    private void SobreButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SobreButtonActionPerformed
        URL imageUrl = getClass().getClassLoader().getResource("assets/icons/android-chrome-192x192.png");
        ImageIcon imagem = new ImageIcon(imageUrl);
    ...
    private void DiretorioRelatorioLabelFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_DiretorioRelatorioLabelFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_DiretorioRelatorioLabelFocusLost
...
//    }
    ...
    private javax.swing.JLabel DiretorioRelatorioLabel;
